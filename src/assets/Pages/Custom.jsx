...
export default function Custom({userData,downloadVcf,sendUserData}) {
...
console.log(selectedLink)
  ...
  return (
<>
<div className='w-[100%]  flex items-center flex-col ' style={{ background: `linear-gradient(${userData.bgThemeValue[0]}, ${userData.bgThemeValue[1]})` }} >
