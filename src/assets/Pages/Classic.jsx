...
export default function Classic({userData,downloadVcf,sendUserData}) {
...
console.log(selectedLink)
  ...
  return (
<>
<div className='w-[100%]  flex items-center flex-col ' style={{ background: 'linear-gradient(30deg, #3B034E, #200C96, #280472, #D30064)' }} >
<div className=' flex justify-center items-center w-[100%]'>
<div className='w-[150px] h-[150px] rounded-[50%] relative'>
<img style={{width:"150px",height:"150px",borderRadius:"50%",marginTop:"50px",objectFit:"cover"}} src={userData?.profileUrl}/>
    ...
    <div  onClick={() => window.open(image.value)} key={index} className=' w-[70px] h-[55px] rounded-[10px] flex justify-center items-center'>
      {image && <img width={40} src={image.image} alt={`icon-${index}`} />}
            ...
            {userData?.custom_links?.map((img, index) => (
              <div className="w-[100%] flex items-center justify-center" onClick={() => sendUserData(userData.id,img.id,"custom")}>
